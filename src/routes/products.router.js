...
import { getAll,getAllByPage,getAllBy, getById, save, update,updatePricesByCategories,restorePricesByCategories, eliminate } from '../controllers/products.controller.js'
